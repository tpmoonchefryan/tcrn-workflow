...
`0.11.8` is the current accepted release candidate. Its compatibility manifest declares
...
The `0.11.8` release candidate records `supportedAosReleases: []`; it does not
