...
`0.11.11` is the current accepted release candidate. Its compatibility manifest declares
...
The `0.11.11` release candidate records `supportedAosReleases: []`; it does not
