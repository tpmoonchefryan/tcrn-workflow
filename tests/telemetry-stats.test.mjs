...
test("STORY-376: the Story 367 injection path records retrieval, bytes, judge, and pull through the same module", async (t) => {
  ...
  assert.deepEqual(new Set(telemetry.records.map((entry) => entry.kind)), new Set(["retrieval", "retrieval-hit", "reference", "pull", "trigger", "injection-bytes", "judge", "collector-self-check"]));
