...
const routeAdditions = new Set([
  ...
  "tests/s300-story-refusal.test.mjs",
...
function validateMap(map) {
  ...
  for (const claim of map.claims) {
    const fields = typeof claim?.id === "string" && (claim.id.startsWith("INIT047-GOAL-") || ["INIT047-INC-255", "INIT047-INC-256"].includes(claim.id))
