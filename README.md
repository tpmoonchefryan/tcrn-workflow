...
- The current accepted release candidate is `0.11.11`; it carries the Story-209 ten-block scope contract, dispatch-readiness validation, closeout verification, source-to-rule conservation, and independent public-world preflight. Publication remains separately governed.
