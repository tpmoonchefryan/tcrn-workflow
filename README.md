...
`Status: 0.1.0-rc.4 (pre-release candidate)` · `License: Apache-2.0` · `Node 24.16.0` · `pnpm 11.3.0` · `Verified claims: 57 (hygiene 12 · inertness 14 · runtime 31)`
...
| **Machine-readable claim ledger** | `verification-map.yaml` binds 57 claims — 12 framework-hygiene, 14 inertness-proof, 31 runtime-capability — to observable reason codes. If a claim's subject changes, its proof must re-run — overclaiming is a build failure, not a style issue. |
...
- **57 machine-verified claims** in `verification-map.yaml`, partitioned as 12 framework-hygiene, 14 inertness-proof, and 31 runtime-capability — the runtime-capability third is the delivered product surface, stated honestly.
