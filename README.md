...
`Status: 0.1.0-rc.4 (pre-release candidate)` · `License: Apache-2.0` · `Node 24.16.0` · `pnpm 11.3.0` · `Verified claims: 44 (hygiene 11 · inertness 14 · runtime 19)`
...
| **Machine-readable claim ledger** | `verification-map.yaml` binds 44 claims — 11 framework-hygiene, 14 inertness-proof, 19 runtime-capability — to observable reason codes. If a claim's subject changes, its proof must re-run — overclaiming is a build failure, not a style issue. |
...
- **44 machine-verified claims** in `verification-map.yaml`, partitioned as 11 framework-hygiene, 14 inertness-proof, and 19 runtime-capability — the runtime-capability third is the delivered product surface, stated honestly.
