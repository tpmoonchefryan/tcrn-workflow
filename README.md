...
![status](https://img.shields.io/badge/status-1.0.1-blue) ![gates](https://img.shields.io/badge/verify%3Ap1-22%20gates-brightgreen) ![claims](https://img.shields.io/badge/proven%20claims-99-brightgreen) ![deps](https://img.shields.io/badge/runtime%20deps-0-success)
...
`Verified claims: 99 (hygiene 13 · inertness 13 · runtime 73)`
...
| **A claim ledger a machine can read** | `verification-map.yaml` binds 99 claims — 13 framework-hygiene, 13 inertness-proof, 73 runtime-capability — to observable reason codes. If a claim's subject changes, its proof must re-run. |
...
- **99 machine-verified claims** in `verification-map.yaml` — 13 framework-hygiene, 13 inertness-proof, 73 runtime-capability. The claims badge above is parsed and compared against the ledger on every run.
