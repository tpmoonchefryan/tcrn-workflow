...
`Status: 0.1.0-rc.4 (pre-release candidate)` · `License: Apache-2.0` · `Node 24.16.0` · `pnpm 11.3.0` · `Verified claims: 59 (hygiene 13 · inertness 13 · runtime 33)`
...
| **Machine-readable claim ledger** | `verification-map.yaml` binds 59 claims — 13 framework-hygiene, 13 inertness-proof, 33 runtime-capability — to observable reason codes. If a claim's subject changes, its proof must re-run — overclaiming is a build failure, not a style issue. |
...
- **59 machine-verified claims** in `verification-map.yaml`, partitioned as 13 framework-hygiene, 13 inertness-proof, and 33 runtime-capability — the runtime-capability third is the delivered product surface, stated honestly.
