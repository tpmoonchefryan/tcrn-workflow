...
`Status: 0.1.0-rc.4 (pre-release candidate)` · `License: Apache-2.0` · `Node 24.16.0` · `pnpm 11.3.0` · `Verified claims: 60 (hygiene 13 · inertness 13 · runtime 34)`
...
| **Machine-readable claim ledger** | `verification-map.yaml` binds 60 claims — 13 framework-hygiene, 13 inertness-proof, 34 runtime-capability — to observable reason codes. If a claim's subject changes, its proof must re-run — overclaiming is a build failure, not a style issue. |
...
- **60 machine-verified claims** in `verification-map.yaml`, partitioned as 13 framework-hygiene, 13 inertness-proof, and 34 runtime-capability — the runtime-capability third is the delivered product surface, stated honestly.
