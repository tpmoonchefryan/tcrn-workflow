...
export const INSTALL_MANIFEST_ITEMS: readonly InstallManifestItem[] = Object.freeze([
  ...
  item("machine.claude-skill", "machine", "claude", "<HOME>/.claude/skills/tcrn-workflow-helper", "user-guided", "probe:helper-skill-digest;sha256=3e9c9856395306266bf3ca5c951ee05b2e39a930846312734b5790362ce5a365"),
  item("machine.codex-skill", "machine", "codex", "<HOME>/.codex/skills/tcrn-workflow-helper", "user-guided", "probe:helper-skill-digest;sha256=3e9c9856395306266bf3ca5c951ee05b2e39a930846312734b5790362ce5a365"),
  item("machine.agents-skill", "machine", "shared", "<HOME>/.agents/skills/tcrn-workflow-helper", "user-guided", "probe:helper-skill-digest;sha256=3e9c9856395306266bf3ca5c951ee05b2e39a930846312734b5790362ce5a365"),
