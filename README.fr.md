...
- La release acceptée actuelle est `0.14.0` ; elle transforme la vue d'extension en un résumé de vérification de taille fixe, refuse une projection de vue hors budget avant l'écriture de l'événement, et cesse de signaler comme refusée une écriture validée dont seule la vue dérivée a échoué. La publication reste régie séparément.
