...
3. **La gouvernance exige un récit sérialisable.** Quand une porte de version demande « qui a décidé cela, et sur quelles preuves ? », un fil canonique unique avec reçus a une seule réponse. Un essaim de fils pairs mutant un état partagé n'en a aucune.
