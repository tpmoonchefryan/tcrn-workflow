...
- Le candidat de release accepté actuel est `0.11.14` ; il comprend le contrat de portée en dix blocs de Story-209, la validation de readiness de dispatch, la vérification de clôture, la conservation source-règle et le preflight indépendant du monde public. La publication reste régie séparément.
