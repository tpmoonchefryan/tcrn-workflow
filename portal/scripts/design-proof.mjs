...
const layoutRequirements = [
  ...
  { name: "number control mapping", source: indexText, text: 'entry.controlType === "number") return `<div class="tcrn-number-input-field"' },
  { name: "number input visual", source: indexText, text: 'data-number-input-visibility="full-value" data-setting-control' },
  { name: "setting choice mapping", source: indexText, text: 'entry.controlType === "enum" && values.length > 0) return `<div class="tcrn-setting-choice"' },
  { name: "select enum mapping", source: indexText, text: 'data-setting-choice-control="select" data-setting-key' },
  { name: "text control mapping", source: indexText, text: 'return `<label class="tcrn-field"><span class="tcrn-sr-only">${esc(label)}' },
  { name: "settings layout mode", source: indexText, text: 'data-settings-layout-mode="container-driven"' },
  { name: "settings layout identity", source: indexText, text: 'data-settings-layout="true"' },
  { name: "settings navigation location", source: indexText, text: 'data-settings-layout-navigation-location="page-hierarchy-section-tabs"' },
  { name: "settings layout form policy", source: indexText, text: 'data-settings-layout-form-policy="single-host-single-column"' },
  { name: "settings layout breakpoints", source: indexText, text: 'data-settings-layout-breakpoint="960px"' },
  { name: "settings content breakpoint", source: indexText, text: 'data-settings-content-breakpoint="720px"' },
  ...
  { name: "two-level page depth", source: indexText, text: 'data-page-hierarchy="true" data-page-hierarchy-depth="two"' },
  ...
  { name: "settings DS candidate", source: indexText, text: 'data-ds-candidate="TCRN-Design-System@1a4709db59af073f1d30403258881999d2364463"' },
  { name: "settings DS contract version", source: indexText, text: 'data-ds-contract-version="ds_consumption_contract_v2"' },
  { name: "settings DS contract digest", source: indexText, text: 'data-ds-contract-digest="6ea12f36efe107af3d9340a6927b974b9bdd88749407a4036c16b2be857e347b"' },
  { name: "settings DS coordination status", source: indexText, text: 'data-ds-contract-status="rejected-awaiting-next-DS112"' },
  { name: "topbar DS mapping status", source: indexText, text: 'data-ds-mapping-status="rejected-awaiting-next-DS112"' },
